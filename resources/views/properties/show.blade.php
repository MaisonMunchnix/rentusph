<x-layouts.public>
    ...
    <div class="container-fluid py-5" style="max-width: 1200px;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('public.properties') }}" class="btn-outline-dark btn-sm"><i class="fas fa-arrow-left me-2"></i>Back to Properties</a>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-4 overflow-hidden" style="border-radius: 20px;">
                    <img src="{{ asset($property->image ?? 'images/rentus.png') }}" class="w-100" style="height: 400px; object-fit: cover;" alt="{{ $property->title }}">
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="javascript:void(0);" onclick="openGallery({{ $index }})" class="gallery-item">
                                <img src="{{ asset($img->path) }}" class="rounded shadow-sm" style="width: 120px; height: 90px; object-fit: cover; border: 2px solid transparent; transition: all 0.3s ease;" onmouseover="this.style.borderColor='var(--accent)';" onmouseout="this.style.borderColor='transparent';">
                            </a>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="sticky-top" style="top: 100px; z-index: 10;">
                    ...
                    <div class="card pricing-card border-0 shadow-sm mb-4 text-center" style="border-radius: 20px;">
                        <div class="card-body py-4">
                            <h5 class="text-muted mb-1 text-uppercase fw-bold" style="font-size: 0.85rem; letter-spacing: 1px;">{{ ucfirst($property->rate_type) }} Rate</h5>
                            <h2 class="font-w800 mb-4" style="font-size: 2.5rem; color: #0f172a;">₱{{ number_format($property->monthly_rate, 2) }}</h2>
                            ...
                            <a href="{{ route('login') }}" class="btn btn-warning btn-lg w-100 shadow-sm font-w700" style="border-radius: 50px;">Book This Stay</a>
                                ...
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span class="font-w600 text-black lh-1" style="font-size: 0.9rem;">{{ $property->floor_area ? $property->floor_area . ' sqm' : 'N/A' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                    ...
                    <div id="galleryCarousel" class="carousel slide" data-bs-ride="false">
                        <div class="carousel-inner text-center">
                            ...
                            <div class="carousel-item {{ $index === 0 ? 'active' : '' }}">
                                <img src="{{ asset($img->path) }}" class="img-fluid rounded" style="max-height: 85vh; object-fit: contain; box-shadow: 0 10px 30px rgba(0,0,0,0.5);" alt="Gallery Image">
                            </div>
                            @endforeach
                        </div>
                        @if($property->galleryImages->count() > 1)
                        <button class="carousel-control-prev" type="button" data-bs-target="#galleryCarousel" data-bs-slide="prev" style="width: 5%;">
                            <span class="carousel-control-prev-icon" aria-hidden="true" style="width: 3rem; height: 3rem;"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#galleryCarousel" data-bs-slide="next" style="width: 5%;">
