    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('customer.explore', ['type' => 'car']) }}" class="text-primary font-w600">View All <i class="fas fa-arrow-right ms-1"></i></a>
            </div>
            <div class="row">
                @forelse($cars as $car)
        ...
        <div class="col-xl-12 mt-4">
            <div class="d-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('customer.explore', ['type' => 'property']) }}" class="text-primary font-w600">View All <i class="fas fa-arrow-right ms-1"></i></a>
            </div>
            <div class="row">
