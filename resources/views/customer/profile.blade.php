        ...
        <div class="col-xl-8 col-lg-10">
            <div class="d-flex align-items-center mb-4">
                <div class="avatar-placeholder me-3">
                    <div style="width: 60px; height: 60px; border-radius: 50%; background: #eab308; color: #0f172a; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; font-weight: 700;">
                        {{ substr($user->name, 0, 1) }}
                    </div>
                </div>
                <div>
                    <h2 class="font-w700 mb-0">My Profile</h2>
