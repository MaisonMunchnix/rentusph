...
<body>
      ...
      <div class="container-fluid px-3 px-md-5">
        ...
        <div class="collapse navbar-collapse" id="welcomeNavbar">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0 nav-links" style="gap: 1.5rem;">
            <li class="nav-item"><a class="nav-link" href="#fleet" style="font-weight: 600; font-size: 1.1rem;">Our
                Fleet</a></li>
            <li class="nav-item"><a class="nav-link" href="#properties"
                style="font-weight: 600; font-size: 1.1rem;">Properties</a></li>
            <li class="nav-item"><a class="nav-link" href="#how-it-works"
                style="font-weight: 600; font-size: 1.1rem;">How it Works</a></li>
            <li class="nav-item"><a class="nav-link" href="#footer" style="font-weight: 600; font-size: 1.1rem;">Reach
                Us</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('public.about') }}"
                style="font-weight: 600; font-size: 1.1rem;">About Us</a></li>
          </ul>
          <div class="d-flex align-items-lg-center header-cta-group mt-3 mt-lg-0" style="gap: 1rem;">
            ...
            <a href="{{ route('register.customer', ['clear_intent' => 1]) }}"
  ...
  <section class="hero">
    ...
    <img
      src="https://images.unsplash.com/photo-1502877338535-766e1452684a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80"
      alt="Luxury Sports Car" class="hero-bg">
  ...
  <section id="fleet" class="fleet">
    <div class="section-header">
      ...
      <p class="section-subtitle">Choose from our reliable and well-maintained vehicles, perfect for Philippine roads
        and any travel need.</p>
    </div>
    ...
    <div class="text-center mt-5">
      <a href="{{ route('public.cars') }}" class="btn btn-outline"
        style="border: 1.5px solid var(--accent) !important; color: #000 !important; background: var(--accent) !important;">View
        More Cars</a>
    </div>
  </section>
  ...
  <section id="properties" class="fleet" style="background-color: #f8fafc;">
    <div class="section-header">
      ...
      <p class="section-subtitle">Discover our handpicked collection of premium properties, from modern urban condos to
        serene beachfront villas.</p>
    </div>
        ...
        <div class="car-card">
          ...
          <div class="car-specs">
            ...
            <span>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
                <path d="M2 20h20M2 14h20M2 8h20M2 2h20"></path>
              </svg>
    ...
    <div class="text-center mt-5">
      <a href="{{ route('public.properties') }}" class="btn btn-outline"
        style="border: 1.5px solid var(--accent) !important; color: #000 !important; background: var(--accent) !important;">View
        More Properties</a>
    </div>
  </section>
  ...
  <section id="how-it-works" class="how-it-works">
    ...
    <div class="steps-container">
      <div class="step">
        ...
        <p class="step-desc">Browse our diverse collection of reliable vehicles to find the best match for your journey.
        </p>
      </div>
      <div class="step">
        <div class="step-icon">
        ...
        <p class="step-desc">Select your pickup and return dates according to your schedule. We offer flexible renting
          durations.</p>
      </div>
      <div class="step">
        <div class="step-icon">
        ...
        <p class="step-desc">Complete your reservation securely online, grab the keys, and enjoy the ultimate driving
          experience.</p>
      </div>
    </div>
  </section>
  ...
  <footer>
    <div class="footer-grid">
      <div>
        ...
        <p class="footer-desc">Cars & Property Rental services. SEC registered to operate Cars, property & other rental
          services in the Philippines. Started operating as DTI 2019 in Batangas. A community (RENT-US) of rentals!
          Serving you anywhere you go!</p>
      </div>
      <div>
        ...
        <ul class="footer-links" style="list-style: none; padding: 0;">
          <li style="margin-bottom: 1rem; display: flex; align-items: flex-start; gap: 0.75rem;">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
              style="color: var(--accent); position: relative; top: 3px;">
              <path
        ...
        <div style="margin-top: 1.5rem;">
          <a href="{{ route('register.affiliate') }}"
            style="color: var(--accent); text-decoration: none; font-weight: 600; display: flex; align-items: center; gap: 0.5rem;">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
