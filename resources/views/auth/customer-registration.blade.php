    ...
    <div class="auth-right">
        <div class="auth-form-box">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" id="phone" class="form-control" placeholder="+63 9XX XXX XXXX" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label" for="address">Address <span style="color:#94a3b8;font-weight:400;">(optional)</span></label>
            ...
            <p class="auth-footer-link">
                ...
                <a href="{{ route('login', session('pending_car_id') ? ['car_id' => session('pending_car_id')] : []) }}">Sign in</a>
            </p>
        </div>
    </div>
