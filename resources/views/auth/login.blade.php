                    ...
                    <div class="card mb-0 h-auto">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <a href="{{ url('/') }}"><img class="logo-auth" src="{{ asset('images/rentus-logo.svg') }}" alt="Logo"></a>
                            </div>
                            ...
                            <div class="new-account mt-3 text-center">
                                <p>Don't have an account? <br>
                                   <a class="text-primary" href="{{ url('register/customer') }}">Sign up as Customer</a> | 
                                   <a class="text-primary" href="{{ url('register/affiliate') }}">Sign up as Affiliate</a>
                                </p>
                            </div>
                        </div>
                    </div>
