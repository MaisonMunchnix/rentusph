...
<head>
    ...
    <style>
        ...
        .car-meta svg { color: #eab308; opacity: 0.8; }
        ...
        .auth-right {
            ...
            align-items: center;
            justify-content: center;
            background: #0b1121; /* Dark theme for split side */
            padding: 2rem 3rem;
            position: relative;
            overflow-y: auto;
        }
        ...
        .auth-split.no-car .auth-right::before { display: none; }
            ...
            <form action="{{ url('login') }}" method="POST">
                ...
                <div class="form-group mt-3 mb-4">
                    <div class="custom-checkbox">
                        ...
                        <label for="basic_checkbox_1">Remember me for 30 days</label>
                    </div>
                </div>
