...
<head>
    ...
    <style>
        ...
        .auth-form-box {
            width: 100%;
            max-width: 400px; /* slightly narrower for login */
        }
        ...
        .auth-split.no-car .form-label { color: #cbd5e1; }
        .auth-split.no-car .form-control {
            background: #0f172a;
            border-color: #334155;
            color: #f1f5f9;
        }
        .auth-split.no-car .form-control::placeholder { color: #475569; }
        ...
        .auth-split.no-car .forgot-password-link {
            color: #94a3b8;
        }
        .auth-split.no-car .forgot-password-link:hover {
            color: #eab308;
        }
    </style>
</head>
...
<div class="auth-split">
    ...
    <div class="auth-left">
        ...
        @if($selectedCar->image)
            <img src="{{ asset($selectedCar->image) }}" alt="{{ $selectedCar->brand }} {{ $selectedCar->model }}" class="car-preview-img">
        @else
        ...
        <div class="auth-form-box">
            ...
            <form action="{{ url('login') }}" method="POST">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="email" name="email" id="email" class="form-control" placeholder="hello@example.com" required>
                </div>
                ...
                <div class="form-group mb-4">
                    <div class="form-check custom-checkbox">
                        ...
                        <label class="form-check-label" for="basic_checkbox_1" style="font-size: 0.85rem;">Remember me</label>
                    </div>
                </div>
            ...
            <p class="auth-footer-link" style="margin-top: 2rem;">
                ...
                <a href="{{ route('register.customer', session('pending_car_id') ? ['car_id' => session('pending_car_id')] : []) }}">Sign up as Customer</a> | 
        ...
        <div class="auth-form-box">
            ...
            <form action="{{ url('login') }}" method="POST">
                ...
                <div class="form-group mb-4">
                    <div class="form-check custom-checkbox">
                        <input type="checkbox" name="remember" class="form-check-input" id="basic_checkbox_1">
                        <label class="form-check-label" for="basic_checkbox_1" style="color: #94a3b8; font-size: 0.85rem;">Remember me</label>
                    </div>
                </div>
