                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-primary btn-xs px-3 me-2" data-bs-toggle="modal" data-bs-target="#viewCustomerModal{{ $customer->id }}">
                                                    View
                                                </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body pt-3">
                    <div class="text-center mb-4">
                        <div class="avatar-wrapper mb-3">
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($customer->name) }}&background=334155&color=fff&size=128" 
                                 alt="{{ $customer->name }}" 
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3">
                                ...
                                <div>
                                    <small class="text-muted d-block" style="font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px;">Email Address</small>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3 h-100">
                                ...
                                <div>
                                    <small class="text-muted d-block" style="font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px;">Phone</small>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center p-3 bg-light rounded-3 h-100">
                                ...
                                <div>
                                    <small class="text-muted d-block" style="font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px;">Joined Date</small>
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-start p-3 bg-light rounded-3">
                                ...
                                <div>
                                    <small class="text-muted d-block" style="font-size: 0.7rem; text-transform: uppercase; letter-spacing: 1px;">Home Address</small>
                ...
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-primary light w-100 py-2 fw-bold" data-bs-dismiss="modal">Close Profile</button>
                </div>
            </div>
        </div>
    </div>
